...
class PhpRenderer
{
     ...
     * Render a templates
     *
     * $data cannot contain templates as a key
     *
     * throws RuntimeException if $templatePath . $templates does not exist
     *
    ...
    /**
     * Renders a templates and returns the result as a string
     *
     * cannot contain templates as a key
     *
     * throws RuntimeException if $templatePath . $templates does not exist
     *
     * @param $template
    ...
    public function fetch($template, array $data = []) {
        if (isset($data['templates'])) {
            throw new \InvalidArgumentException("Duplicate templates key found");
        }
