        ...
        switch ($name) {
            case 'parent':
                ...
                if (!$this->parser->getParent() && !$this->parser->hasTraits()) {
                    throw new Twig_Error_Syntax('Calling "parent" on a templates that does not extend nor "use" another templates is forbidden.', $line, $this->parser->getStream()->getSourceContext());
                }
