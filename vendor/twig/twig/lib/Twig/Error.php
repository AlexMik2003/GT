...
class Twig_Error extends Exception
{
    ...
    public function __construct($message, $lineno = -1, $source = null, Exception $previous = null)
    {
        if (null === $source) {
            ...
            // for compat with the Twig C ext., passing the templates name as string is accepted
            $name = $source;
        } else {
            $name = $source->getName();
    ...
    /**
     * Gets the source context of the Twig templates where the error occurred.
     *
    ...
    /**
     * Sets the source context of the Twig templates where the error occurred.
     */
