...
class Twig_Environment
{
     ...
     *                  * name: set the autoescaping strategy based on the templates name extension
     *                  * PHP callback: a PHP callback that returns an escaping strategy based on the templates "name"
     *
     ...
     * Loads a templates.
     *
     * @param string|Twig_TemplateWrapper|Twig_Template $name The templates name
     *
    ...
    /**
     * Loads a templates internal representation.
     *
    ...
    public function loadTemplate($name, $index = null)
    {
        ...
        if (!class_exists($cls, false)) {
            ...
            if (!class_exists($cls, false)) {
                throw new Twig_Error_Runtime(sprintf('Failed to load Twig templates "%s", index "%s": cache is corrupted.', $name, $index), -1, $source);
            }
        }
     ...
     *
     * @param string|Twig_Source $source The templates source code
     * @param string             $name   The templates name (deprecated)
     *
    ...
    public function compileSource($source, $name = null)
    {
        ...
        try {
            ...
            throw new Twig_Error_Syntax(sprintf('An exception has been thrown during the compilation of a templates ("%s").', $e->getMessage()), -1, $source, $e);
        }
    }
     ...
     *
     * @throws Twig_Error_Runtime When the templates cannot be found
     */
