...
class Twig_TokenStream
{
     ...
     * @param string|null $name   The name of the templates which tokens are associated with
    ...
    public function next()
    {
        if (!isset($this->tokens[++$this->current])) {
            throw new Twig_Error_Syntax('Unexpected end of templates.', $this->tokens[$this->current - 1]->getLine(), $this->source);
        }
    ...
    public function look($number = 1)
    {
        if (!isset($this->tokens[$this->current + $number])) {
            throw new Twig_Error_Syntax('Unexpected end of templates.', $this->tokens[$this->current + $number - 1]->getLine(), $this->source);
        }
