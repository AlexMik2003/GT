 ...
 *
 * This class is an implementation detail of how templates compilation currently
...
abstract class Twig_Template implements Twig_TemplateInterface
{
    ...
    /**
     * Returns debug information about the templates.
     *
    ...
    /**
     * Returns information about the original templates source code.
     *
     * @return Twig_Source
     */
    ...
    public function displayParentBlock($name, array $context, array $blocks = array())
    {
        ...
        if (isset($this->traits[$name])) {
            ...
            throw new Twig_Error_Runtime(sprintf('The templates has no parent and no traits defining the "%s" block.', $name), -1, $this->getSourceContext());
        }
    }
    ...
    public function displayBlock($name, array $context, array $blocks = array(), $useBlocks = true)
    {
        ...
        if (null !== $template) {
            try {
                ...
                throw new Twig_Error_Runtime(sprintf('An exception has been thrown during the rendering of a templates ("%s").', $e->getMessage()), -1, $template->getSourceContext(), $e);
            }
        } elseif (false !== $parent = $this->getParent($context)) {
            $parent->displayBlock($name, $context, array_merge($this->blocks, $blocks), false);
        } else {
            @trigger_error(sprintf('Silent display of undefined block "%s" in templates "%s" is deprecated since version 1.29 and will throw an exception in 2.0. Use the "block(\'%s\') is defined" expression to test for block existence.', $name, $this->getTemplateName(), $name), E_USER_DEPRECATED);
        }
    }
    ...
    /**
     * Returns whether a block exists or not in the current context of the templates.
     *
     * This method checks blocks defined in the current templates
    ...
    /**
     * Returns all block names in the current context of the templates.
     *
     * This method checks blocks defined in the current templates
     * or defined in "used" traits or defined in parent templates.
     *
    ...
    protected function displayWithErrorHandling(array $context, array $blocks = array())
    {
        try {
            ...
            throw new Twig_Error_Runtime(sprintf('An exception has been thrown during the rendering of a templates ("%s").', $e->getMessage()), -1, $this->getSourceContext(), $e);
        }
    }
    ...
    protected function getAttribute($object, $item, array $arguments = array(), $type = self::ANY_CALL, $isDefinedTest = false, $ignoreStrictCheck = false)
    {
        ...
        if ($object instanceof Twig_TemplateInterface) {
            ...
            $message = sprintf('Calling "%s" on templates "%s" from templates "%s" is deprecated since version 1.28 and won\'t be supported anymore in 2.0.', $item, $object->getTemplateName(), $this->getTemplateName());
            if ('renderBlock' === $method || 'displayBlock' === $method) {
                $message .= sprintf(' Use block("%s"%s) instead).', $arguments[0], $self ? '' : ', templates');
            } elseif ('hasBlock' === $method) {
                $message .= sprintf(' Use "block("%s"%s) is defined" instead).', $arguments[0], $self ? '' : ', templates');
